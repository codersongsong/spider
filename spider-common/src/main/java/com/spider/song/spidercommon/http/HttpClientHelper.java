package com.spider.song.spidercommon.http;
...
public class HttpClientHelper {
    ...
    public static void main(String[] args) {
        ...
        params.put("appid", "wxc9dcb0c5c62d261b");
        params.put("secret", "3959105f56edb4de5ee49d4eb13db08f");

        System.out.println(sendGet(url,params,"utf-8"));
    }
